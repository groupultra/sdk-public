...
from moobius.types import Button, CanvasElement, StyleElement, ContextMenuElement, MessageBody
    ...
    async def on_button_click(self, button_click):
        ...
        if button_id == "message_btn".lower():
            ...
            if value == "New Channel".lower():
                ...
                await self.download_file(logo_url, local_path, assert_no_overwrite=False)
