...
from moobius.basic.types import MessageDown
import asyncio
import inspect

# with database
class MoobiusWand:
    def __init__(self, service, wand, http_api, _ws_payload_builder):
        self.service = service
        self.wand = wand
        self.http_api = http_api
        self._ws_payload_builder = _ws_payload_builder
        
    
    # self.service.wand = self.service.wand
    ...
    # for name, method in inspect.getmembers(self.service, predicate=inspect.iscoroutinefunction):
    #     setattr(self, name, wrap_method(method, self))
    # name _handle_received_payload
    # name fetch_real_characters
    # name handle_received_payload
    # name on_action
