...
class DatabaseInterface(ABC):
    ...
    Each demo's on_start() function passes calls MoobiusStorage(self.service_id, channel_id, db_config=self.db_config)
    ...
    Then, in the on_start() function each demo will call MoobiusStorage(self.service_id, channel_id, db_config=self.db_config)
