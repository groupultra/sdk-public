    ...
    def __setitem__(self, key, value):
        ...
        if is_success:
            ...
            if self.strict_mode:
                ...
                log(f'Failed to save key {key} to database: {err_msg}. Inconsistency may occur.', error=True)
                dict.__setitem__(self, key, value)    
    ...
    def __delitem__(self, key):
        ...
        if is_success:
            ...
            if self.strict_mode:
                ...
                log(f'Failed to delete key {key} from database: {err_msg}. Inconsistency may occur.', error=True)
                dict.__delitem__(self,key)
